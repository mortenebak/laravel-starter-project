    ...
    <section class="bg-white dark:bg-neutral-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <div class="font-normal mb-2 bg-primary-600 text-white p-1 rounded-xl inline-flex text-xs px-3">
                ...
                <p class="max-w-2xl mb-6 font-light text-neutral-500 lg:mb-8 md:text-lg lg:text-xl dark:text-neutral-400">
                    Build, automate, and scale business processes with confidence. From marketing to operations, finance, legal, and more. Start out with this starter!
                </p>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://picsum.photos/800/600" alt="mockup" class="rounded-xl">
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-neutral-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
                ...
                <p class="mb-6 font-light text-neutral-500 md:text-lg dark:text-neutral-400">
                    From finding the right talent to building a diverse workforce, from onboarding to managing benefits, and from payroll to offboarding, we help you manage your most important asset: your people.
                </p>
            </div>
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <x-h3>Marketing</x-h3>
                    <x-p>Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your marketing goals every month with our marketing plan.</x-p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <x-h3>Legal</x-h3>
                    <x-p>Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</x-p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <x-h3>Business Automation</x-h3>
                    <x-p>Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</x-p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <x-h3>Finance</x-h3>
                    <x-p>Audit-proof software built for critical financial operations like month-end close and quarterly budgeting.</x-p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <x-h3>Enterprise Design</x-h3>
                    <x-p>Craft beautiful, delightful experiences for both marketing and product with real cross-company collaboration.</x-p>
                </div>
                <div>
                    <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <x-h3>Operations</x-h3>
                    <x-p>Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</x-p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-neutral-900">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div class="mt-4 md:mt-0">
                <x-h2>Let's create more tools and ideas that brings us together.</x-h2>
                <x-p size="lg">
                    We are constantly trying to understand how we can help teams to work better together. Our goal is to create tools and ideas that bring us closer to our goals.
                </x-p>
