    ...
    <div class="dark:text-slate-200">
        ...
        <form class="space-y-4" wire:submit.prevent="changePassword">
            <div class="form-group">
                <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white" for="current_password">Current
                    Password</label>
            ...
            <div class="form-group">
                <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white" for="new_password">New
                    Password</label>
            ...
            <div class="form-group">
                <label class="block mb-2 text-sm font-bold text-gray-900 dark:text-white" for="confirm_password">Confirm
                    Password</label>
