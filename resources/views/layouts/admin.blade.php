            ...
            <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-main-white dark:bg-gray-800 border-b dark:border-b-slate-800 md:px-12 md:py-0">
                ...
                <div x-data="{dropdownMenu: false}" class="relative ml-auto" @click.outside="dropdownMenu = false" @keyup.escape.window="dropdownMenu = false">
                    ...
                    <div x-show="dropdownMenu" x-transition="" class="absolute top-0 right-0 p-2 mt-2 bg-white border border-gray-200 rounded-md overflow-hidden shadow-lg w-44 space-y-2" style="z-index: 51; display: none;">
                        ...
                        <a href="/admin/employees/reset-password" class="flex space-x-2 items-center p-2 text-sm text-gray-500 hover:text-gray-900 hover:bg-secondary hover:text-primary rounded-md transition ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
